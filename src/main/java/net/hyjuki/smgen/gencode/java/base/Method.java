...
public class Method extends Element {
    ...
    public String indent() {
        return GenUtils.indent(this.indent);
    }
    ...
    public String getExecMethod() {
        if (GenUtils.isEmpty(this.objName)) {
            return this.getName() + getExecParameterList();
        }
        return GenUtils.concatByDot(this.objName, this.getName()) + getExecParameterList();
    }
    ...
    public String getDefineMethod() {
        ...
        sb.append(this.getType().getClassName()).append(GenUtils.SPACE)
                .append(this.getName())
    ...
    private String getParameterList() {
        String paramString = "(";
        if (!GenUtils.isEmpty(this.parameters)) {
    ...
    public String formatString() {
        ...
        if (this.isExec()) {
            ...
            return GenUtils.indent(1) + this.getDefineMethod()
                    + GenUtils.SEMICOLON;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(GenUtils.line().length());
    }
}
