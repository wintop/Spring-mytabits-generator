...
import net.hyjuki.smgen.java.ProjectJava;
...
public class MyBatisGenerator {
    ...
    public void setProjectDir() {
        ...
        this.projectDir = CommonUtils.concatDir(rootDir, projectName, CommonUtils.DIR_SRC, CommonUtils.DIR_MAIN);
    }
    ...
    public String generatorComboFiles() throws IOException {
    ...
    public void generaterMapperXmlFile() throws IOException {
        ...
        String xmlFile = CommonUtils.concatDir(projectDir,
