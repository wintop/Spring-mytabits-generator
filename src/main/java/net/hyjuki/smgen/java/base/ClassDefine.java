...
public class ClassDefine extends Element {
    ...
    public String formatString() {
        ...
        if (this.extend != null) {
            extendName = CommonUtils.SPACE + ClassType.EXTENDS.type()
                    + CommonUtils.SPACE + this.extend.getClassName();
        }

        if (this.implement != null) {
            implementName = CommonUtils.SPACE + ClassType.IMPLEMENTS.type()
                    + CommonUtils.SPACE + this.implement.getClassName();
        }
